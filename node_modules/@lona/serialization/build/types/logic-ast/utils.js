...
function subNodes(node) {
    switch (node.type) {
        case 'loop':
            return [node.data.expression].concat(node.data.block);
        case 'branch':
            return [node.data.condition].concat(node.data.block);
        case 'declaration':
        ...
        case 'functionCallExpression':
            return [node.data.expression].concat(node.data.arguments);
        ...
        case 'functionType':
            return [node.data.returnType].concat(node.data.argumentTypes);
        case 'array':
