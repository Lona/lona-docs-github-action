...
export declare function isLonaTokens(node: Content): node is LonaTokens;
...
export declare type JSX = JSXImport | JSXExport | JSXValue;
/**
  Each node in mdast falls into one or more categories of Content that group nodes with similar characteristics together.
  */
export declare type Content = TopLevelContent | ListContent | TableContent | RowContent | PhrasingContent | JSX;
/**
  Top-level content represent the sections of document (block content), and metadata such as frontmatter and definitions.
  */
export declare type TopLevelContent = BlockContent | FrontmatterContent | DefinitionContent | JSX;
/**
  Block content represent the sections of document.
  */
export declare type BlockContent = Paragraph | Heading | ThematicBreak | Blockquote | List | Table | HTML | Code | JSX | Page;
/**
