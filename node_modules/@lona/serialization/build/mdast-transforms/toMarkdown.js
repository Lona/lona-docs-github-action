...
function childrenValue(node, joinWith = '') {
...
function toMarkdown(node) {
    switch (node.type) {
        ...
        case 'listItem': {
            return `- ${typeof node.checked !== 'undefined'
                ? `[${node.checked ? 'x' : ''}] `
                : ''}${childrenValue(node)}`;
        }
        case 'list': {
            ...
            const contents = node.children
                ...
                return formatting_1.indentBlockWithFirstLinePrefix(listItemContent, ordered ? `${index + 1}. ` : `- `);
            })
                .join('\n');
            if (spread) {
                return '\n' + contents + '\n';
...
\`\`\``;
        ...
        case 'table': {
            ...
            children.splice(1, 0, `| ${node.children[0].children
