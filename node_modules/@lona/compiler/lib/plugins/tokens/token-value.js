...
const LogicUnify = __importStar(require("../../helpers/logic-unify"));
let getField = (key, fields) => {
...
exports.create = (value) => getColorValue(value) ||
