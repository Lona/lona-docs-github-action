...
export declare type Helpers = {
    ...
    ast: {
        ...
        traversal: {
            declarationPathTo: (node: LogicAST.SyntaxNode | LogicAST.Pattern | LogicAST.Identifier, id: string) => string[];
            /** Find the node with the matching id */
            findNode: (rootNode: LogicAST.SyntaxNode | LogicAST.Pattern | LogicAST.Identifier, id: string) => LogicAST.SyntaxNode | LogicAST.Pattern | LogicAST.Identifier | undefined;
            /** Find the parent of the node with the matching id */
            findParentNode: (rootNode: LogicAST.SyntaxNode | LogicAST.Pattern | LogicAST.Identifier, id: string) => LogicAST.SyntaxNode | undefined;
            /**
             ...
             */
            reduce: <T>(node: LogicAST.SyntaxNode, callbackfn: (previousValue: T, currentNode: LogicAST.SyntaxNode, config: TraversalConfig) => T, initialResult: T, config?: TraversalConfig) => T;
        };
    };
};
declare const _default: (workspacePath: string, outputPath?: unknown, _reporter?: Reporter | undefined) => Promise<Helpers>;
