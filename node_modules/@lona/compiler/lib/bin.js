...
yargs_1.default
    ...
    .command('config [workspace]', 'Get the configuration of a Lona workspace', cli => {
    ...
    index_1.getConfig(argv.workspace)
        .then(config => {
    ...
    .command('convert [path]', 'Convert a file or workspace to a specific format', cli => {
    cli.positional('path', {
    ...
    index_1.convert(argv.path, argv.format, argv)
        .then(result => {
        if (result) {
